 ...
 */
final class Version20220226213741 extends AbstractMigration
{
    public function getDescription(): string
    {
        return 'Mise à jour des tables forme_juridique et societe';
    }

    public function up(Schema $schema): void
    {
        // this up() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE forme_juridique DROP societe_constitue_associe_unique, DROP personne_morale_constitue_sans_activite');
        $this->addSql('ALTER TABLE societe ADD societe_constitue_associe_unique TINYINT(1) NOT NULL, ADD personne_morale_constitue_sans_activite TINYINT(1) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE forme_juridique ADD societe_constitue_associe_unique TINYINT(1) NOT NULL, ADD personne_morale_constitue_sans_activite TINYINT(1) NOT NULL, CHANGE forme_juridique forme_juridique VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
